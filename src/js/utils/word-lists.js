...
/**
 * Get list of legitimate -ly words that aren't adverbs
 * @returns {Object} Dictionary of -ly words to exclude from adverb detection
 */
export function getLyWords() {
  return {
    actually: 1,
    additionally: 1,
    allegedly: 1,
...
/**
 * Get dictionary of complex words and their simpler alternatives
 * @returns {Object} Dictionary of complex words with simpler suggestions
 */
...
/**
 * Get dictionary of qualifying/weakening words and phrases
 * @returns {Object} Dictionary of qualifying words
 */
export function getQualifyingWords() {
  return {
    "i believe": 1,
    "i consider": 1,
    "i don't believe": 1,
